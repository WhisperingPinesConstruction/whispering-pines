      ...
      <div className="mx-auto max-w-4xl px-8 text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          <a
            ...
            aria-label="Facebook"
            className="flex h-10 w-10 items-center justify-center rounded-full bg-sage-green/10 text-sage-green transition-all hover:bg-sage-green hover:text-cream"
          >
        ...
        <p className="mt-6 text-xs text-stone-gray">
